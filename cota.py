...
##############################################
    def bsx(seed,ttt,rrr,ooo,uuu,ic,u):		
       ...
       while True:
            ...
            rf    =int(fhash[:5],16)
            if rf//1000>=500 and rz>50 and rq>50 and rn>50 and rm>50 and car>=31 and hq2[0]=='0' and 'CH' in q:
                  bool='over'
                  l=q
                  break
            elif rf//1000<=500 and rz<50 and rq<50 and rn<50 and rm<50 and car<=20 and hq2[0]=='8' and 'cC' in q:
                  bool='under'
                  l=q
                  break
            # if ic%2==1:
