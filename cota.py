...
##############################################
    def bsx(seed,ttt,rrr,ooo,uuu):		
       ...
       while True:
            while True:
                ts=randint(35,40)
                q=random.choice([pwd.num(ts),pwd.zum(ts),pwd.upd(ts),pwd.lod(ts),pwd.ran(ts)])
                hq=pwd.sha5(q)
                rz=pwd.resuv(z,q)
            ...
            rm = pwd.resuv(mmm,q)
            rn = pwd.resuv(nnn,q)
            if rz//10==0 and ttt%2==0:#and 50<rq :#and uuu%2==1:#and 50<rn and 50<rm:
                  bool='over'
                  l=q
                  break
            if rz//10==7 and ttt%2==1 :#if rz<round(uuu,0):#and 50>rn and 50>rm:
                  bool='over'
                  l=q
                  break
